...
public final class CapabilityXunXianWenDaoImp implements ICapabilityXunXianWenDao {
	...
	@Override
	public int getPharmacistLevel() {return this.pharmacistLevel;}
	@Override
	public float getMagic() {return this.magic;}
	@Override
	public float getExperience() {return this.experience;}
	@Override
	public float getPharmacistExperience() {return this.pharmacistExperience;}
	@Override
	...
	@Override
	public void setPharmacistLevel(int level) {this.pharmacistLevel=level;}
	@Override
	public void setMagic(float magic) {this.magic=magic;}
	@Override
	public void setExperience(float exp) {this.experience=exp;}
	@Override
	public void setPharmacistExperience(float exp) {this.pharmacistExperience=exp;}
	@Override
	...
	public String toString() {
		...
		string+=getPharmacistExperience()+this.pharmacistExperience+" | ";
		string+=this.getMaxHealth();
		return string;
	}
